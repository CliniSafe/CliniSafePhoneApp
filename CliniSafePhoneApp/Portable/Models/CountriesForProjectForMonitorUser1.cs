...
namespace CliniSafePhoneApp.Portable.Models
{
    ...
    public class Country1
    {
        ...
        public class CountriesForProjectForMonitorUser : INotifyPropertyChanged, ICountriesForProjectForMonitorUser
        {
            ...
            //public static async Task<string> GetCountriesForProjectForMonitorUserListAsync(int project_ID)
            //{
            //    string result = await App.PhoneAppSoapService.GetCountriesForProjectForMonitorUserListAsync(project_ID);
            //    return result;
            //}



            public static async Task<string> GetCountriesForProjectForMonitorUserStringAsync(int project_ID)
            {
                string result = await App.PhoneAppSoapService.GetCountriesForProjectForMonitorUserStringAsync(project_ID);
                return result;
            }
        }
